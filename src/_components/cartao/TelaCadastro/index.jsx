...
import validar from '@/_utils/validators/cartao-validator'
...
const TelaCadastro = ({ initialCartao, info, onSubmit }) => {
    const [cartao, setCartao] = useState(initialCartao || defaultCartao)
